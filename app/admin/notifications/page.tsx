...
import NotificationMobileCard from "./components/NotificationMobileCard";
...
import NotificationCreateDrawer, {
  ...
  type UserOption,
} from "./components/NotificationCreateDrawer";
      ...
      async () => {
        try {
          const {
            ...
            .from("notifications")
            .select(
              "user_id, customer_email, created_at"
            )
            .not(
              "user_id",
              "is",
          ...
          (data || []).forEach(
            (item) => {
              ...
              if (
                ...
                console.warn(
                  "[Notifications] Ignoring invalid user_id:",
                  userId
                );
