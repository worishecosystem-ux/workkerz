...
export default function AdminsTab() {
    ...
    try {
      ...
      const normalizedAdmins: Admin[] = (data.admins || []).map(
        (admin: Admin) => {
          ...
          /*
           * Keep last known departments locally.
           * This prevents departments from becoming blank
           * after refresh if API temporarily returns [].
           */
          if (roles.length === 0 && typeof window !== "undefined") {
            try {
              ...
              console.error("Unable to restore saved departments:", error);
            }
          }

          /*
           * Save current departments locally whenever
           * API gives us valid department data.
           */
          if (roles.length > 0 && typeof window !== "undefined") {
            try {
              ...
              console.error("Unable to save departments:", error);
            }
          }
  ...
  const filteredAdmins = useMemo(() => {
    ...
    return admins.filter((admin) => {
      ...
      const matchesRole =
        roleFilter === "all" || admin.admin_roles.includes(roleFilter);
  ...
  const updateAdmin = async (
    ...
    try {
      ...
      if (changes.admin_roles !== undefined && typeof window !== "undefined") {
        try {
          localStorage.setItem(
          ...
          console.error("Unable to save departments locally:", error);
        }
      }
      setAdmins((current) =>
        current.map((admin) =>
      ...
      setSuccess(data.message || "Admin updated successfully.");
    } catch (error) {
      console.error("Update admin error:", error);

      setError(
        error instanceof Error ? error.message : "Unable to update admin.",
      );
    } finally {
      setSaving(false);
    }
  ...
  const toggleDepartment = async (role: AdminRole) => {
    ...
    const currentRoles = selectedAdmin.admin_roles || [];
  ...
  const handleAccountRoleChange = async (role: AccountRole) => {
    if (!selectedAdmin) return;

    if (role === "super_admin" && selectedAdmin.role !== "super_admin") {
  ...
  const handleDeleteAdmin = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/admin/${selectedAdmin.id}`, {
        method: "DELETE",
        headers,
      });
  ...
  const disabledAdmins = admins.filter((admin) => !admin.is_active).length;
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <header className="bg-white border-b border-gray-100 px-4 sm:px-6 lg:px-8 py-5">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 h-11 px-5 rounded-xl bg-[#FF5C39] hover:bg-[#e54e2e] text-white text-sm font-bold"
          >
      ...
      <main className="p-4 sm:p-6 lg:p-8">
        ...
        {error && !selectedAdmin && !showCreate && (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          <div className="bg-white border border-gray-100 rounded-2xl p-5">
            <p className="text-xs font-semibold text-[#64748B]">Total Admins</p>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-5">
            <p className="text-xs font-semibold text-[#64748B]">Disabled</p>
          ...
          <div className="flex flex-col lg:flex-row gap-3">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full lg:w-52 h-11 pl-10 pr-4 rounded-xl border border-gray-200 bg-[#F8FAFC] text-sm outline-none"
              >
            ...
            <select
              ...
              className="w-full lg:w-40 h-11 px-4 rounded-xl border border-gray-200 bg-[#F8FAFC] text-sm outline-none"
            >
            ...
            <button
              ...
              onClick={loadAdmins}
              disabled={loading}
              className="h-11 px-4 rounded-xl border border-gray-200 bg-white text-sm font-bold text-[#475569] flex items-center justify-center gap-2"
            >
              <RefreshCw
        ...
        <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
          <div className="px-5 sm:px-6 py-4 border-b border-gray-100">
            <h2 className="font-bold text-[#0F172A]">Admin Accounts</h2>
          ...
          {loading ? (
            <div className="p-12 text-center">
              ...
              <p className="text-sm text-[#64748B] mt-3">Loading admins...</p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="rounded-2xl border border-gray-100 p-5 mb-5">
                <div className="flex items-center justify-between">
                  ...
                  >
                    {selectedAdmin.is_active ? "Active" : "Disabled"}
                  </span>
                </div>
              ...
              <div className="rounded-2xl border border-gray-100 p-5 mb-5">
                <div className="mb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-2.5 py-1 rounded-full bg-orange-50 text-[#FF5C39] text-xs font-bold">
                ...
                {selectedAdmin.role === "super_admin" ? (
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-purple-700 mt-1">
                          Super Admin already has access to all admin management
                          areas. Department assignments are not required.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {(Object.entries(roleLabels) as [AdminRole, string][]).map(
                      ([role, label]) => {
                        const checked =
                          selectedAdmin.admin_roles.includes(role);
                        ...
                        return (
                          ...
                          >
                            <input
                              ...
                              checked={checked}
                              disabled={saving}
                              onChange={() => toggleDepartment(role)}
              ...
              <div className="rounded-2xl border border-gray-100 p-5 mb-5">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleAccountRoleChange(e.target.value as AccountRole)
                  }
                  disabled={saving}
                ...
                <div className="divide-y divide-gray-100">
                  ...
                  <div className="px-5 py-4 flex items-start justify-between gap-4">
                    ...
                    <div className="flex flex-wrap justify-end gap-1.5 max-w-[280px]">
                      {selectedAdmin.admin_roles.length > 0 ? (
                        selectedAdmin.admin_roles.map((role) => (
                          <span
                            key={role}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-red-600 mt-1">
                      Permanently remove this admin account and its department
                      assignments.
                    </p>
                  </div>
                </div>
            ...
            <form onSubmit={handleCreateAdmin} className="p-6 space-y-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {(Object.entries(roleLabels) as [AdminRole, string][]).map(
                    ([role, label]) => {
                      const checked = form.admin_roles.includes(role);
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  onClick={() => setShowCreate(false)}
                  disabled={saving}
                  className="flex-1 h-11 rounded-xl border border-gray-200 text-sm font-bold text-[#64748B] hover:bg-gray-50 disabled:opacity-50"
                >
                  Cancel
                </button>
