...
> = {
  construction: { color: "#F97316", bg: "#FFF7ED", label: "Construction" },
  plumbing: { color: "#3B82F6", bg: "#EFF6FF", label: "Plumbing" },
  electrical: { color: "#EAB308", bg: "#FEFCE8", label: "Electrical" },
  driving: { color: "#10B981", bg: "#ECFDF5", label: "Driving" },
};
                  ...
                  <div className="flex-1 mt-10">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      <div>
                        ...
                        <p className="text-[#64748B] text-sm mt-13">
                          {worker.specialty}
                        </p>
                      </div>
