...
interface OrderState {
  ...
  // Delivery is kept for compatibility with saved orders.
  // Final delivery charge is handled separately by Workkerz.
  delivery: number;
...
export function EAurixOrderConfirmed() {
  ...
  const [dbOrderId, setDbOrderId] =
    useState("");

  const [waSent, setWaSent] =
    useState(false);
...
┃ Total: ₹${(
      ...
      const lines = [
        ...
        `┃ ${
          isFreeDeliveryEligible
            ? "FREE within 2 km"
            : "Final charge to be confirmed"
        }`,
        "┃ Minimum order for free delivery: ₹2,000",
        "┃ Beyond 2 km: Workkerz team will confirm the final charge",
        "",
      ...
      lines.push(
        "💳 *Payment Summary*",
        "┃────────────────────",
        `┃ Items Total : ₹${cartTotal.toFixed(2)}`,
        `┃ Delivery : ${
          isFreeDeliveryEligible
            ? "FREE within 2 km"
            : "To be confirmed"
        ...
        `┃ ${
          isFreeDeliveryEligible
            ? "Order qualifies for FREE delivery within 2 km."
            : "Free delivery within 2 km is available on orders of ₹2,000+."
        }`,
        "┃ Final delivery charges beyond the free eligibility will be confirmed by the Workkerz team after coordinating with the shop.",
        "",
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(
      () => {
        window.open(
          `https://wa.me/${whatsappNum}?text=${message}`,
          "_blank",
        );
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-500">
                      {isFreeDeliveryEligible
                        ? "FREE within 2 km on this order"
                        : "Final delivery charge will be confirmed"}
                    </p>
                  </div>
                  ...
                  <p className="mt-0.5 text-[9px] leading-4 text-emerald-700">
                    {isFreeDeliveryEligible ? (
                      <>
                        ...
                        . Beyond 2 km, final delivery
                        charges will be confirmed by
                        the Workkerz team.
                      </>
                    ) : (
                      <>
                        Free delivery within 2 km is
                        available on orders of{" "}
                        <b>₹2,000+</b>. Final delivery
                        charges will be confirmed by
                        the Workkerz team after
                ...
                {[
                  ...
                  },
                  {
                    title:
                      "Preparing Order",
                    subtitle:
                      "Seller is verifying and preparing your materials",
                    done: false,
                  },
                  {
                    title:
                    ...
                    subtitle:
                      "Workkerz team will confirm delivery details and charges",
                    done: false,
                  },
                  {
                    title:
